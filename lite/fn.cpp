...
sem = new RFASem(cg->readFile(name1) ? (long)1 : 0LL);		// 08/07/01 AM.
...
RFASem *sem1 = 0;
_TCHAR *str1=0;
long long num= 0LL;			// Default is 0th or last elt's node.
float fnum=0; // unused // 12/15/14 AM.
...
RFASem *array_sem=0;
_TCHAR *attr=0;
long long numeric=0LL, descending=0LL;
