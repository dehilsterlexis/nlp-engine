...
if (num1 > len || num2 > len || num3 > len)
	...
	if (num1 > len) num1 = len;	// RECOVER. // 08/22/11 AM.
	if (num2 > len) num2 = len;	// RECOVER. // 08/22/11 AM.
	if (num3 > len) num3 = len;	// RECOVER. // 08/22/11 AM.
	}
...
if (num1 > len || num2 > len || num3 > len || num4 > len || num5 > len)
	...
	if (num2 > len) num2 = len;	// RECOVER. // 08/22/11 AM.
	if (num3 > len) num3 = len;	// RECOVER. // 08/22/11 AM.
	if (num4 > len) num4 = len;	// RECOVER. // 08/22/11 AM.
	if (num5 > len) num5 = len;	// RECOVER. // 08/22/11 AM.
	}
...
#ifdef _OLD_TABOO_
// succeed(), fail(), and exitpass() NOT ALLOWED IN A FN.		// 08/18/08 AM.
if (!nlppp->select_)															// 08/18/08 AM.
	;	// Error.																// 08/18/08 AM.
else if (!strcmp_i(name,_T("succeed"))									// 08/18/08 AM.
 || !strcmp_i(name,_T("fail"))											// 08/18/08 AM.
 || !strcmp_i(name,_T("exitpass")) )									// 08/18/08 AM.
	{
	Node<Pn> *x = nlppp->select_;											// 08/18/08 AM.
	Pn *xpn = x->getData();													// 08/18/08 AM.
	_TCHAR *xnm = xpn->getName();											// 08/18/08 AM.
	while (x && strcmp_i(xnm,_T("_DECL")))								// 08/18/08 AM.
		{
		x = x->parent();														// 08/18/08 AM.
		if (x)																	// 08/18/08 AM.
			{
			xpn = x->getData();												// 08/18/08 AM.
			xnm = xpn->getName();											// 08/18/08 AM.
			}
		}
